    ...
    <ProtectedPage featureName="AI Agent">
      <div className="flex flex-col h-[calc(100vh-140px)] md:h-[calc(100vh-180px)] max-w-none md:max-w-3xl mx-auto">
        <div className="flex-shrink-0 mb-3">
          <h1 className="text-lg md:text-xl font-bold">ORCA AI Agent — Cố vấn tài chính đa nhiệm</h1>
          <p className="text-xs text-slate-500 mt-1">
            Thị trường · Tài chính cá nhân · Doanh nghiệp · Wealth management. Số liệu mã từ Data Engine; không bịa giá.
          </p>
        </div>
        ...
        <div className="flex-1 overflow-y-auto scrollbar-hide mb-3">
          {messages.length === 0 ? (
            <div className="text-center py-8 md:py-10">
              <div className="text-slate-500 text-sm mb-4">Thử một câu hỏi:</div>
        ...
        <form onSubmit={handleSubmit} className="flex-shrink-0 flex gap-2 items-end">
          <textarea
            ...
            placeholder="Hỏi về mã, thị trường, ngân sách, DN, hoặc phân bổ tài sản…"
            rows={1}

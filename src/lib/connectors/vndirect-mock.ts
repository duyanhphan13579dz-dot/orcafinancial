...
const FIXTURES: Record<string, { close: number; prevClose: number; volume: number; beta: number }> = {
  VNINDEX: { close: 1832.12, prevClose: 1824.5, volume: 850_000_000, beta: 1.0 },
  VN30: { close: 1895.6, prevClose: 1888.1, volume: 380_000_000, beta: 1.0 },
  VN100: { close: 1780.4, prevClose: 1772.8, volume: 620_000_000, beta: 1.0 },
  HNX: { close: 268.45, prevClose: 266.9, volume: 95_000_000, beta: 0.9 },
  UPCOM: { close: 104.2, prevClose: 103.8, volume: 45_000_000, beta: 0.7 },
...
export const VNDIRECT_MOCK_SOURCE = MOCK_SOURCE;

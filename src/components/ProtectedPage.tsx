    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center px-4">
        <div className="panel p-8 max-w-md w-full text-center">
          ...
          <p className="text-slate-400 mt-3 text-sm">Đăng nhập để xem {featureName}.</p>
          <div className="mt-6 flex flex-col gap-3">
            <Link href="/auth/login" className="btn-orca min-h-11 py-3">
              Đăng nhập
            </Link>
            <Link href="/auth/register" className="btn-orca-outline min-h-11 py-3">
              Đăng ký miễn phí
            </Link>

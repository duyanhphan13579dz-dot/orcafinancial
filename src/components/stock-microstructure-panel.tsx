...
import type { OrderBookSnapshot, ForeignFlowSnapshot } from "@/lib/connectors/microstructure";
...
export function StockMicrostructurePanel({ orderBook, foreignFlow }: Props) {
  ...
  return <div className="grid gap-4 xl:grid-cols-2">
    <section className="panel overflow-hidden">
      ...
      {unavailable ? <div className="p-5 text-xs text-slate-500">Sổ lệnh chưa khả dụng. Hệ thống sẽ tự cập nhật khi nguồn dữ liệu vi cấu trúc được kết nối.</div> : <>
